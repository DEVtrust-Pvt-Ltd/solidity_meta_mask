 ...
 * Description: Plugin is made for testing and learning purpose only.
 * Version: 1.0.0
 * Author: Devtrust
 * License: GPL2
 */
...
require_once(ROOTDIR . 'crypt_setting.php');
require_once(ROOTDIR . 'crypto_chain.php');
