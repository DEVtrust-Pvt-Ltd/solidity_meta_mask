                ...
                <tbody>
                    ...
                    <form name="frm" method="post">
                        ...
                        <tr>
                            ...
                            <td style="padding-top: 60px;"><input type="text" id="accounts" placeholder="<?= $place; ?>" style="width: 350px;" name="waladd" readonly>

                                <br>
                                <span id="valid" style="color:green;"></span>
                                <input type="hidden" name="network" id="network">
                                <input type="hidden" name="chainId" id="chainId">
                                <input type="hidden" name="upid" value="<?= $data[0]->id; ?>">
                            </td>
                        ...
                        <tr>
                            ...
                            <td> <span class="no">Test</span><label class="switch">
                                    ...
                                    ?>
                                    <input type="checkbox" name="mode" <?php echo $checked1; ?>>
                                    <span class="slider round"></span>
