jQuery('body').on('updated_checkout', function() {
    ...
    function updatestatus(txHash, status) {       
        ...
        jQuery.ajax({
            type: 'POST',
            url: ajaxurl,
            data: { "action": "storedata","currDate": curr_dat, "Date": dat, "sendeth": sendeth, "tranfee": tranfee, "dollerval": dollerval, "sendadd": sendadd, "recieveadd": recieveadd, "txhash": txhash, "uname": uname, "desc": desc, "status": status },
