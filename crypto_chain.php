    ...
    <div class="container">
      ...
      <table id="example" class="table table-striped table-bordered table-sm" style="word-break: break-all;">
        ...
        <tbody>
          ...
          ?>
            <tr>
              <td style="width:80px;"><?php echo $dat->date_time; ?></td>
              <td><?php echo $dat->trans_id; ?></td>
              <td style="width:100px;"><?php echo $dat->user_name; ?></td>

              <td style="width:80px;"> <?php echo $dat->product_description; ?></td>
              <td><?php echo $dat->sender_address; ?></td>
              <td><?php echo $dat->receiver_address; ?></td>
              <td style="width:55px;"><?php echo $dat->eth_value; ?></td>
              <td style="width:50px;"><?php echo $dat->eth_fees; ?></td>
              <td style="width:70px;"><?php echo $dat->doller_value; ?></td>
              <td style="width:80px;"><?php echo $dat->status; 
